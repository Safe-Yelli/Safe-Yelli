...
```{r operations on data, echo=FALSE}
# allData$`What kind of incident was this?` <- as.vector(str_split(allData$`What kind of incident was this?`,","))
...
```{r Creating Filters, echo=FALSE, message=FALSE, warning=FALSE}
...
# map  
tags$div(class = "crosstalk-filters",
         tagList(#tags$h2(''),)
           #dateFilter,
           map,
