...
description: A citizen centric tool to report harassment, assault and other crimes
  on the streets in Bengaluru. See our community's citizen reported crime data on
  a map.
draft: no
banner:
  title: Documenting harassment in Bengaluru
  content: "_**A citizen centric tool to report harassment, assault and other crimes
    on the streets in Bengaluru. See our community's citizen reported crime data on
    a map.**_ \n \n ಬೆಂಗಳೂರು ಗರವಾಸಿಗಳಿಗೆ  ಇಲ್ಲಿ ನಡೆಯುವ ದೌರ್ಜನ್ಯ ಮತ್ತು ಕಿರುಕುಳವನ್ನು
    ರಿಪೋರ್ಟ್ ಮಾಡುವ ಉಪಕರಣ. ಇಲ್ಲಿ ಸಂಗ್ರಹವಾದ ಅಪರಾಧ ವರದಿಗಳನ್ನು ನಕ್ಷೆಯ ಮೇಲೆ ಕಾಣಬಹುದು "
  button:
    enable: yes
...
if(!is.na(allData$`time of incident`)){
  allData$popupText <-
  paste0(
    '<strong>',
    allData$`kind of incident`,
    '</strong> <br/> <br/>',
    allData$`date of incident`, ',' , allData$`time of incident`,
    '<br/> <br/>',
    allData$`description`,
    ' '
  )
