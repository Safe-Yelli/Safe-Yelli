...
lamps$status <- lamps$status %>% 
  str_replace_all("not working", replacement = "not_working") %>% 
  str_replace_all("needs maintenance", replacement = "needs_maintenance")
...
colourLegLight<- colorFactor(brewer.pal(n = 5, name = "BrBG"),
                              levels = c("not_working", "needs_maintenance", "dull", "working"),
                             lamps$status)
...
map <- leaflet( roads,
 ...
 addPolylines(data = sidewalks,
  ...
  addLegend(position="bottomright",
            ...
            title = paste0("Status of sidewalk segments, (", nrow(sidewalks), ")"),
            colors = c('#9a4032', "#ddd095", "gray"),
            labels = c(labelCount("Gaps", sidewalks$Walkability)
  ...
  addLegend(position="bottomright",
            ...
            title= paste0("Status of crossings, (", nrow(crossings), ")"),
  ...
  addLegend(position="bottomright",
            ...
            title= paste0("Status of roads, (", nrow(roads), ")"),
  ...
  addLegend(position="bottomleft",
            values = lamps$status,
            title= paste0("Status of street lamps, (", nrow(lamps), ")"),
            colors = c('#8c510a', "#bf812e", "#c7e9e4", "#00665d"),
            labels = c(labelCount("not_working", lamps$status)
                      ,labelCount("needs_maintenance", lamps$status)
  ...
  addLayersControl(
                   overlayGroups = c("sidewalks", "roads", "street lamps","crossings", "illumination traces"),
